 ...
 */
class ExperienciaController extends AbstractActionController
{
     ...
     *
     * @return object|bool $experienciaDao
     */
    protected $experienciaDao;
    ...
    public function listadoAction()
    {
        ...
        return array(
            'experiencia' => $this->getExperienciaDao()->traerTodos()
        );
    }
     ...
     * @return object|bool
     */
    private function getExperienciaDao()
    {
        if (! $this->experienciaDao) {
            $sm = $this->getServiceLocator();
            $this->experienciaDao = $sm->get('Recursos\Model\Dao\ExperienciaDao');
        }
        return $this->experienciaDao;
    }
}
