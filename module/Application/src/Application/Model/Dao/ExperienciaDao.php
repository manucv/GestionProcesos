<?php
/**
 * Objeto de acceso a base de datos referente a la tabla 'experiencia'.
 *
...
/**
 * Clase que define el objeto ExperienciaDao y sus funciones asociadas.
 */
class ExperienciaDao implements SpecificFunctionsInterface
{
     ...
     * @return bool
     */
    public function guardar(Experiencia $experiencia)
    {
        /*
