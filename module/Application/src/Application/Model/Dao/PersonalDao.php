<?php
/**
 * Objeto de acceso a base de datos referente a la tabla 'personal'.
 *
...
/**
 * Clase que define el objeto PersonalDao y sus funciones asociadas.
 */
class PersonalDao implements SpecificFunctionsInterface
{
     ...
     * @return bool
     */
    public function guardar(Personal $personal)
    {
        /*
