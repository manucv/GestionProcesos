<?php
/**
 * Objeto de acceso a base de datos referente a la tabla 'cargo'.
 *
...
/**
 * Clase que define el objeto CargoDao y sus funciones asociadas.
 */
class CargoDao implements SpecificFunctionsInterface
{
     ...
     * @return bool
     */
    public function guardar(Cargo $cargo)
    {
        /*
