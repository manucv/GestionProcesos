<?php
/**
 * Objeto de acceso a base de datos referente a la tabla 'departamento'.
 *
...
/**
 * Clase que define el objeto DepartamentoDao y sus funciones asociadas.
 */
class DepartamentoDao implements SpecificFunctionsInterface
{
     ...
     * @return bool
     */
    public function guardar(Departamento $departamento)
    {
        /*
