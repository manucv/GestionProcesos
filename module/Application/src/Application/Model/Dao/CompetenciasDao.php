<?php
/**
 * Objeto de acceso a base de datos referente a la tabla 'competencia'.
 *
...
/**
 * Clase que define el objeto CompetenciaDao y sus funciones asociadas.
 */
class CompetenciasDao implements SpecificFunctionsInterface
{
     ...
     * @return bool
     */
    public function guardar(Competencia $competencia)
    {
        /*
